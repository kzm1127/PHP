<?php
// TODO
define('ARTICLE_FILE', 'C:\Users\Owner\article.json');
define('USER_FILE', 'C:\Users\Owner\user.csv');
define('BLOG_TITLE', 'Marie Blog');
define('ADMIN_BLOG_TITLE', 'Admin Marie Blog');
